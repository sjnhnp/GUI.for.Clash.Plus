...
16. **macOS 12+ 最低版本要求**
    - 文件: `build/darwin/Info.plist` (LSMinimumSystemVersion=12.0 + NSAppTransportSecurity)
    - 文件: `.github/workflows/release.yml` (macos-latest + MACOSX_DEPLOYMENT_TARGET=12.0)
